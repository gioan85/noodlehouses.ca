...
<script>
  ...
  function detectmob() { 
	 ...
	 || navigator.userAgent.match(/Windows Phone/i)
		...
		mobile_browser = true;
		document.write('\<script type="text/javascript" src="js/mobile_main.js"\>\</script\>\<link rel="stylesheet" type="text/css" href="css/mobile_main.css"\>');	
	  }
	 else {
		 mobile_browser = false;
		 document.write('\<script type="text/javascript" src="js/main.js"\>\</script\>\<link rel="stylesheet" type="text/css" href="css/main.css"\>');
	  }
}
