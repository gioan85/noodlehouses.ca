...
<table class="list_food" cellpadding="0" cellspacing="1" border="0">
    ...
    <tr class="add_field">
        <td><input type="text" class="input" id="food_key" /></td>
        <td><input type="text" class="input" id="food_name"/></td>
        <td><input type="text" class="input" id="food_price" /></td>
        <td><textarea class="textarea" id="description" rows="5" cols="45"></textarea></td>
    ...
    <tr class="update_field">
        ...
        <td><input type="text" class="input" id="update_food_key" value=""/></td>
...
<script type="text/javascript">
	...
	function add_food(){
		...
		string += '&food_key=' + food_key.val().replace(/&/g, 'and');
		string += '&food_name=' + food_name.val().replace(/&/g, 'and');
		string += '&food_price=' + parseFloat(food_price.val());
		string += '&description=' + food_description.val().replace(/&/g, 'and') ;
	...
	function update_food(id,key,name,price,description){
		//alert(name);
		$('.update_field').toggle('blind');
		$('#update_food_id').val(id);
		$('#update_food_key').val(key);
