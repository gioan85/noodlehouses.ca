...
var event = [
	{public:'2019-12-24, 17:00:00', expire:'2019-12-26, 00:00:00'},
	{public:'2019-12-31, 17:00:00', expire:'2020-01-01, 00:00:00'}
]

var stop_order = false;
...
$(document).ready(function(){	
	...
	function event_(){
		...
		for(var i=0; i< event.length; i++){
			var start = new Date(event[i].public);
			var end = new Date(event[i].expire);
			if(start.valueOf() <= today.valueOf() && today.valueOf() <= end.valueOf())
				stop_order = true;
		}
		console.log('stop order ', stop_order)
	};
	...
	$('.pick_info').find('.radio_button').bind('tapone click mouseup touchend',function(){
		...
		if( hour <=10 && $(this).attr('id') == '30_minutes')

		{

			messagebox('Our bussiness will open at 10am.<br>You can order after!');
